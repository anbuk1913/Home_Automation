...
PinMapping pinMappings[] = {
    ...
    {"68b53d4407c5a83e90871468", 5, false},
    {"68b53d4407c5a83e90871469", 4, false},
    {"68b53d4407c5a83e9087146a", 0, false},
    {"68b53d4407c5a83e9087146b", 2, false},
    {"68b53d4407c5a83e9087146c", 14, false},
    {"68b53d4407c5a83e9087146d", 12, false},
    {"68b53d4407c5a83e9087146e", 13, false},
    {"68b53d4407c5a83e9087146f", 15, false},
    {"68b53d4407c5a83e90871470", 10, false},
};
...
void setup() {
    ...
    for (int i = 0; i < numPins; i++) {
        ...
        Serial.println("GPIO " + String(pinMappings[i].gpioPin) + 
                       " initialized for pin ID: " + pinMappings[i].pinId);
    }
...
void parseAndUpdatePins(String jsonResponse) {
    ...
    for (JsonObject pin : pins) {
        ...
        Serial.println("Pin: " + pinName + " (ID: " + pinId + 
                       ") - State: " + String(pinState));
    ...
    for (int i = 0; i < numPins; i++) {
        if (pinMappings[i].pinId == pinId) {
            if (pinMappings[i].currentState != newState) {
                ...
                Serial.println("Updated GPIO " + String(pinMappings[i].gpioPin) + 
                               " to " + String(newState ? "HIGH" : "LOW") + 
                               " for pin ID: " + pinId);
            }
            return;
        }
